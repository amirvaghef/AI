...
Public Class XException
   ...
   Public Class ExceptionBuilder
      ...
      Default Public ReadOnly Property Message( _
         ...
         Get
            With New StringBuilder(String.Concat(MessageSegment0.ToString, MessageSegments))
               If _Sender IsNot Nothing Then
                  .Insert(0, String.Concat(_Sender.GetType.Name, "-Exception: "))
               End If
               Return XException.Create(_InnerEx, .ToString)
            End With
         End Get
      End Property
   ...
   Private Shared Function Create( _
         ...
         ByVal ParamArray MessageSegments() As Object) As XException
      Dim X As New XException(InnerEx, String.Concat(MessageSegments))
#If DEBUG Then
