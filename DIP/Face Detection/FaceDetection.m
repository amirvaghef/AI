...
for k = 1 : regionNO
    ...
    if(euler > 20)
        ...
        %    cropimg = normxcorr2(templateImage,cropimg);
        %    cropimg = im2bw(cropimg, 0.2);
        %end
        ...
        %        plot( tempCentroid(1,1) + boundBox(1), tempCentroid(1,2) + boundBox(2),'--bs','MarkerFaceColor','g','MarkerSize',5);
        %    end
        %else
