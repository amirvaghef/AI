    ...
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (ArrayList array in sentences)
            {
                ...
                double unigram = ProbeUnigram(array, Regex_Patterns.Instance._TrapListCorpuse, Regex_Patterns.Instance._WordListCorpuse, Regex_Patterns.Instance._DigitListCorpuse, Regex_Patterns.Instance._MarkListCorpuse);
                unigramAverage += unigram;
                dataGridViewSentence.Rows[o].Cells["Unigram"].Value = unigram;
                double bigram = ProbeBigram(array, Regex_Patterns.Instance._BigramListCorpuse);
                bigramAverage += bigram;
                dataGridViewSentence.Rows[o].Cells["Bigram"].Value = bigram;
                double trigram = ProbeTrigram(array, Regex_Patterns.Instance._TrigramListCorpuse);
                trigramAverage += trigram;
                dataGridViewSentence.Rows[o].Cells["Trigram"].Value = trigram;
            }
